...
public class Main {
	...
	public static void parseArguments(String[] args) {
		...
		if (!configfile.equals("")) {
			...
			System.out.println(
					"Damit der FunkrufSlave ohne GUI gestartet werden kann, muss eine Konfigurationsdatei angegeben werden!");
			System.exit(1);
		}
			...
			try {
				...
				if (mainWindow != null) {
					mainWindow.showError("Server starten",
							"Beim Initialisieren des Senders ist ein Fehler aufgetreten!");
				}
	...
	public static void main(String[] args) {
		...
		System.out.println("RasPager - Version " + VERSION
