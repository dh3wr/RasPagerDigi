...
public class Pocsag {
	...
	public static ArrayList<Integer> encodeNum(int addr, int func, String text) {
		...
		// cwCnt = 1 + (POC_BITS_PER_DIGIT * text.length() + POC_BITS_PER_CW -
		// 1) / POC_BITS_PER_CW;
	...
	public static ArrayList<Integer> encodeStr(int addr, int func, String text) {
		...
		// Anzahl der benoetigten Codewoerter berechnen. und ein gross genuges
		// Page-Objekt erzeugen.
		// cwCnt = 1 + (POC_BITS_PER_CHAR * text.length() + POC_BITS_PER_CW - 1)
		// / POC_BITS_PER_CW;
