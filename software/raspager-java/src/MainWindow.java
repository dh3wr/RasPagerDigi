	...
	public MainWindow(Log log) {
		...
		addWindowListener(new WindowListener(){
			...
			public void windowClosing(WindowEvent event) {
				...
				if(Main.running && !showConfirm("Beenden", "Der Server läuft zur Zeit. Wollen Sie wirklich beenden?")) {
					return;
				}
		...
		masterIP.setBounds(masterListBounds.x + masterListBounds.width + 12, masterListBounds.y + masterAddLabel.getHeight() - 16, 126, 18);
		...
		masterAdd.setBounds(masterListBounds.x + masterListBounds.width + 15, masterIP.getY() + masterIP.getHeight() + 5, 120, 18);
		...
		masterRemove.setBounds(masterListBounds.x + masterListBounds.width + 15, masterAdd.getY() + masterAdd.getHeight() + 5, 120, 18);
